...
// const mylist = UNISWAP_DEFAULT_LIST.tokens.map(item => item.address)
// console.log(
//   'UNISWAP_DEFAULT_LIST',
//   UNISWAP_DEFAULT_LIST,
//   DEFAULT_TOKEN_LIST_URL,
//   mylist,
//   mylist.includes('0xb705268213d593b8fd88d3fdeff93aff5cbdcfae ')
// )
...
export default createReducer(initialState, builder =>
  builder
    .addCase(fetchTokenList.pending, (state, { payload: { requestId, url } }) => {
      console.log('url', state.byUrl, url)
      state.byUrl[url] = {
        current: null,
        pendingUpdate: null,
        ...state.byUrl[url],
    ...
    .addCase(updateVersion, state => {
      ...
      if (!state.lastInitializedDefaultListOfLists) {
        ...
        console.log('listUrl', newListOfListsSet)
...
console.log('listUrl', initialState)
